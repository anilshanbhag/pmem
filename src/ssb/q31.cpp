...
float runQuery(int* lo_orderdate, int* lo_custkey, int* lo_suppkey, int* lo_revenue, size_t lo_len,
  ...
  int *ht_c = (int*) _mm_malloc(2 * c_len * sizeof(int), 256);
